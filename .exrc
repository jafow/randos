...
set pastetoggle=<F10>
set runtimepath=~/.vim,~/dotfiles/.vim/pack/git-plugins/start/ale,~/.vim/bundle/snippets,~/.vim/bundle/syntastic-local-eslint.vim,~/.vim/bundle/tlib_vim,~/.vim/bundle/ultisnips,~/.vim/bundle/vim-addon-mw-utils,~/.vim/bundle/vim-commentary,~/.vim/bundle/vim-fugitive,~/.vim/bundle/vim-lucius,~/.vim/bundle/vim-snipmate,~/.vim/bundle/vim-snippets,~/.vim/bundle/vim-surround,~/.vim/bundle/vim-unimpaired,~/.vim/bundle/vim-vinegar,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,~/.vim/bundle/vim-snipmate/after,~/.vim/bundle/ultisnips/after,~/.vim/after,~/dotfiles/.vim/pack/git-plugins/start/ale/after
set shiftround
set shiftwidth=4
set showmatch
set smartcase
